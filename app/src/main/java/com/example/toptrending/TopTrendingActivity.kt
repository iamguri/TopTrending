...
class TopTrendingActivity : AppCompatActivity(), NewsItemClicked {
    ...
    private fun fetchData() {
        val url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=6f05a43b852841dba1b77fc941d95ac7"
